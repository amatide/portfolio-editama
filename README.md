...
![GitHub Pages](https://img.shields.io/badge/Live-editama.my.id-00d4ff?logo=githubpages&logoColor=white)
...
Portofolio profesional **single-page HTML murni** yang menampilkan profil, pengalaman kerja, pendidikan, keahlian, teknologi, dan proyek di bidang **Rekam Medis & Informasi Kesehatan** serta eksplorasi **digital health**.
...
|-------|------------|
| **Frontend** | Pure HTML5 |
| **Styling** | CSS3 (Glassmorphism + animasi) |
| **Logic** | Vanilla JavaScript (no framework) |
| **Hosting** | GitHub Pages |
| **Custom Domain** | Jagoan Hosting (`editama.my.id`) |
...
| Platform | Handle |
|----------|--------|
| 🌐 **LinkedIn** | [www.linkedin.com/in/editama](https://www.linkedin.com/in/editama/) |
...
| Item | Configuration |
|------|---------------|
| **Domain** | `editama.my.id` (reg at [Jagoan Hosting](https://jagoanhosting.com)) |
| **Nameserver** | `ns1.jagoanhosting.id`, `ns2.jagoanhosting.id` |
| **DNS A Record** | `185.199.108.153`, `185.199.109.153`, `185.199.110.153`, `185.199.111.153` (GitHub Pages) |
| **DNS CNAME `www`** | → `amatide.github.io` |
